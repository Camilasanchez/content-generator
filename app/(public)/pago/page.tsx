    ...
    <main className="min-h-screen bg-white text-gray-900 p-6">
      <div className="max-w-2xl mx-auto text-center mt-20 bg-gray-50 p-8 rounded-2xl shadow-lg">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500">(Acceso ilimitado a las funciones premium)</p>
        </div>

        <a
          href="https://tu-plataforma-de-pago.com" // reemplaza con tu enlace real de checkout
        ...
        <p className="text-sm text-gray-500 mt-4">
          ¿Tienes preguntas? <Link href="/contacto" className="text-indigo-600 hover:underline">Contáctanos</Link>
        </p>
      </div>
    </main>
  );
